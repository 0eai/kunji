        ...
        {phase === 'confirm' ? (
          <>
            ...
            <p className="text-[15px] text-muted leading-relaxed mb-6">
              Check this code matches the one on your other device. If it doesn't, cancel — someone
              may be intercepting the link.
            </p>
            <div className="font-mono tabular text-4xl tracking-[0.2em] text-ink mb-8">
              {fingerprint}
            </div>
            <Btn onClick={() => setPhase('received')} className="w-full">
          ...
          <>
            ...
            <p className="text-[15px] text-muted leading-relaxed mb-8">
              ...
              <strong className="text-ink font-medium">Security → Link a device</strong> and scan
              this code.
            </p>
